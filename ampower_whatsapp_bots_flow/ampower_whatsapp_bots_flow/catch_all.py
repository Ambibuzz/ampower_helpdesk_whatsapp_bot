...
import frappe
from ampower_whatsapp_bots_flow.ampower_whatsapp_bots_flow.opt_in import (
    handle_onboarding,
...
def handle_catch_all(doc):
    ...
    if optin:
        ...
        if ticket_type:
            from ampower_whatsapp_bots_flow.ampower_whatsapp_bots_flow.ticket_create import (
                handle_ticket_entry,
            )
